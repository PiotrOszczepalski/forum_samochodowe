...
<head>
    <meta charset="UTF-8">
    <title>Posty użytkowników</title>
</head>
...
<body>
    <section id="kontener">
            ...
            <section id="kontent">
                ...
                <?php 
                  $sql2 = "SELECT name FROM user_form WHERE user_type = 'user'";
                  ...
                  while ($rekord2 != null) {
                    ...
                    while ($rekord != null) {
                        ...
                        echo "<a href='delete_admin_user.php?delID=$tempID' id='btn'>Usuń post</a>";
                        echo "<a href='form_update_admin_user.php?delID=$tempID' id='btn'>Edytuj post</a>";
                        echo "</section>";
                        $rekord = mysqli_fetch_row($wynik);
                      }
                  }
